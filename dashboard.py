...
url = 'https://labdados.com/produtos'           # url que contem a tabela

# criação de side bar
regioes = ['Brasil', 'Centro-Oeste', 'Nordeste', 'Norte', 'Sudeste', 'Sul']             

st.sidebar.title('Filtros')
regiao = st.sidebar.selectbox('Região', regioes)            # filtro por checkbox
if regiao == 'Brasil':
    regiao = ''
...
response = requests.get(url, params= query_string)               # pega a resposta com o filtro de regiao

dados = pd.DataFrame.from_dict(response.json())
dados['Data da Compra'] = pd.to_datetime(dados['Data da Compra'], format = '%d/%m/%Y')


# criação de filtros por vendedor
